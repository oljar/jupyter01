...
class View(ttk.Frame):
    def __init__(self, parent):
        ...
        self.open_name_var_tab_1 = StringVar()
        ...
        self.open_button_data_tab_1 = ttk.Button(lf101, text='Wskaż plik csv', command=self.show_open_file_clicked)
